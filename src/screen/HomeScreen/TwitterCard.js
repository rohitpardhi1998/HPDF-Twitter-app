         ...
         <Card>
           <CardItem>
             <Left>
               ...
               <Body style ={{flexDirection: 'row'}}>
                 <UserDetails
                   titleText="Enrique Iglesias"
                   bodyText="Happy #Halloween..."
                   twitterName='@enrique'
                   lastSeenTime='01Nov'/>
           ...
           <CardItem style={{justifyContent: 'flex-end'}}>
               ...
               <Button small iconLeft transparent>
                 <Icon name="text" />
                 <Text style={ styles.buttonTextStyle }>208</Text>
               </Button>

             <Button small iconLeft transparent>
                <Icon name="git-compare" />
                <Text style={ styles.buttonTextStyle } >817</Text>
              </Button>

               <Button small iconLeft transparent>
                 <Icon name="heart" />
                 <Text style={ styles.buttonTextStyle }>5,271</Text>
               </Button>
